...
把 username 替换成自己的自己的用户名。例如我叫 smilejack ，我要创建的仓库名就是
...
>注意：新添加的内容，不一定立刻能显示到 smilejack.github.io ，可能会有五六分钟的延迟。
...
### 如何在 smilejack.github.io 仓库中使用 markdown
...
到 smilejack.github.io 的项目仓库中，首先在 index.html 中添加如下内容：
...
然后，就到 https://github.com/smilejack/smilejack.github.io 仓库首页，找到 Create New File 按钮，创建一个新文件，叫做
